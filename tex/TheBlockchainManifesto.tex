...
\begin{abstract}
\noindent The allignment of Ethereum Classic with the
\href{http://www.bisgit.org/}{Blockchain Alliance for Good} promotes the usage
of blockchain technology as a sustainable vehicle to do good rather than evil.
Based on The Blockchain Alliance for Good's Manifesto\cite{Bisgit2017}, these
are the principles that guide our mission to promote openness, innovation \&
opportunity on the Blockchain.
\end{abstract}
}
